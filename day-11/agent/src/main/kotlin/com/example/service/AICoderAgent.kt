...
private suspend fun tolRegistry(): ToolRegistry {
    /// Create the ToolRegistry with tools from the MCP server
    val mcpClient = Client(clientInfo = Implementation(name = "MCP client for my reminders", version = "1.0.0"))
    mcpClient.connect(
